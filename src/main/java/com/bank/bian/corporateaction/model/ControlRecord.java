package com.bank.bian.corporateaction.model;
...
/**
 * The BIAN control record for this service domain: "Corporate Action Event Procedure".
 *
 ...
 * to its asset type (Corporate Action Event). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Corporate Action Event Procedure";
